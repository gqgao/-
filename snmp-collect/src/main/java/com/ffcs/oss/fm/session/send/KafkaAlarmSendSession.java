...
public class KafkaAlarmSendSession implements AlarmSendSession {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(KafkaAlarmSendSession.class);
	...
	public void sendAlarm(String alarm) {
		try {
			...
			String key = String.valueOf(JSONObject.fromObject(alarm).get("EQUIPMENTNAME"));
